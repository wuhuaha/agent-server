...
class RealtimeScenarioRunner:
    ...
    async def run_text_scenario(self, text: str) -> ScenarioResult:
        ...
        async with self._connect() as ws:
            ...
            await self._collect_until_active_or_end(ws, result)
    ...
    async def run_audio_scenario(
        ...
        async with self._connect() as ws:
            ...
            await self._collect_until_active_or_end(ws, result, received_audio=received_audio)
    ...
    async def run_server_end_scenario(self) -> ScenarioResult:
        ...
        async with self._connect() as ws:
            ...
            await self._collect_until_active_or_end(ws, result, stop_on_server_end=True)

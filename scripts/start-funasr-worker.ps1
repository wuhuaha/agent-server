...
$env:AGENT_SERVER_FUNASR_TRUST_REMOTE_CODE = "false"
$env:AGENT_SERVER_FUNASR_USE_ITN = "true"

conda run -n $CondaEnv python -m agent_server_workers.funasr_service --host $BindHost --port $Port --model $Model --device $Device --language $Language --disable-update --use-itn

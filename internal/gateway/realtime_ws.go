...
func appendBargeInDecisionLogAttrs(attrs []any, decision voice.BargeInDecision) []any {
	return append(attrs,
		...
		"barge_in_semantic_complete", decision.SemanticComplete,
		"barge_in_semantic_intent", decision.SemanticIntent,
		"barge_in_semantic_confidence", decision.SemanticConfidence,
